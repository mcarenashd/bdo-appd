...
// Fix: Add missing ChevronUpIcon export
...
export const ChatBubbleLeftRightIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.537a55.456 55.456 0 01-2.074 0l-3.722-.537A2.121 2.121 0 013 14.894v-4.286c0-.97.616-1.813 1.5-2.097m16.5 0a2.121 2.121 0 00-2.121-2.121H6.621A2.121 2.121 0 004.5 8.511m16.5 0v.001M6.115 6.463a2.121 2.121 0 01-2.121-.213l-3.354-2.42a.212.212 0 010-.322l3.354-2.42a2.121 2.121 0 012.121-.213M21.885 6.463a2.121 2.121 0 002.121-.213l3.354-2.42a.212.212 0 000-.322l-3.354-2.42a2.121 2.121 0 00-2.121-.213" />
    </Icon>
);
...
export const DocumentChartBarIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m-1.125 0H5.625A2.25 2.25 0 003.375 6v12a2.25 2.25 0 002.25 2.25h12.75a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25h-9.75" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 11.25l-2.625 2.625-2.625-2.625m2.625 2.625V7.5" />
    </Icon>
);
...
export const CalendarDaysIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0h18M12 15.75h.008v.008H12v-.008zm0-2.25h.008v.008H12v-.008zm-2.25 2.25h.008v.008H9.75v-.008zm0-2.25h.008v.008H9.75v-.008zm-2.25 2.25h.008v.008H7.5v-.008zm0-2.25h.008v.008H7.5v-.008zm6.75-2.25h.008v.008h-.008v-.008zm2.25 2.25h.008v.008H16.5v-.008zm0-2.25h.008v.008H16.5v-.008zm-4.5 0h.008v.008h-.008v-.008z" />
    </Icon>
);

export const TableCellsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5M3.75 6.75h16.5M12 3.75v16.5" />
    </Icon>
);
